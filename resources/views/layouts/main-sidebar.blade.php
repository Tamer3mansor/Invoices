                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @can('الفواتير الغير مدفوعة')
                            <li><a class="slide-item" href="{{ Route('invoices.un_paid') }}">الفواتير الغير مدفوعة</a></li>
                        @endcan
                        @can('الفواتير المدفوعة جزئيا')
                            <li><a class="slide-item" href="{{ Route('invoices.p_paid') }}">الفواتير المدفوعة جزئيا</a></li>
                        @endcan
                    </ul>
                </li>
                @can('ارشيف الفواتير')
                    <li class="side-item side-item-category"><a href="{{ Route('Archive.index') }}">الأرشيف</a></li>
                @endcan
            @endcan
            <!-- Repeat similar fixes for other sections -->
            @can('التقارير')
