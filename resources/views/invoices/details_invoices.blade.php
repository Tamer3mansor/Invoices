                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="2">
                                                                    ...
                                                                    <a class="btn btn-outline-success btn-sm"
                                                                        href="{{ Route('attachment.file', ["file_name" => $attachment->file_name, "invoice_number" => $attachment->invoice_number]) }}"
                                                                        role="button"><i class="fas fa-eye"></i>&nbsp;
                                                                        عرض</a>

                                                                    <a class="btn btn-outline-info btn-sm"
                                                                        href="{{ Route('attachment.download', ["file_name" => $attachment->file_name, "invoice_number" => $attachment->invoice_number]) }}"
